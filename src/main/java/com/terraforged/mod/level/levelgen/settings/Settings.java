...
public record Settings(WorldSettings world, ClimateSettings climate, RiverSettings rivers, FilterSettings filters) {
	public static final Settings DEFAULT = new Settings(WorldSettings.DEFAULT, ClimateSettings.DEFAULT, RiverSettings.DEFAULT, FilterSettings.DEFAULT);
